...
public class CreateEncryptedEHR extends Request{
	...
	public CreateEncryptedEHR(String userId, String owner, byte[] name, byte[] age, byte[] weight, byte[] diagnosis, byte[] prescriptions, byte[] other) {
		super();
		this.userId = userId;
		this.owner = owner;
		this.name = name; 
